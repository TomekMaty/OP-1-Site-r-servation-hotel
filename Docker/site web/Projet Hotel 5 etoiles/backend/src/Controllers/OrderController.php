...
class OrderController
{
    ...
    public function store(): void
    {
        ...
        // ── Chercher la chambre automatiquement depuis la réservation active ──
        ...
        if ($activeBooking) {
            ...
            // Fallback si pas de réservation active (client externe, etc.)
        ...
        // ── Notification Telegram avec boutons URL ───────────────────
    ...
    /**
     * Cherche la réservation active (en cours ou à venir aujourd'hui)
     * avec une chambre physique attribuée pour cet utilisateur.
     */
